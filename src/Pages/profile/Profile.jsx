...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      try {
        ...
        else { console.error("Error fetching posts:", postsError); }
  ...
  const handleUpdateProfile = async (e) => {
     ...
     try {
       ...
       setSuccess("Profile updated successfully"); setEditMode(false);
     } catch (err) { 
  ...
  return (
    <div className="profile-page">
        ...
        {editMode ? (
           <form onSubmit={handleUpdateProfile} className="profile-form"> 
                <div className="form-group">
                    ...
                    <input type="text" id="display_name" name="display_name" value={profileData.display_name} onChange={handleInputChange} placeholder="Your display name" />
                </div>
                <div className="form-group">
                    <label htmlFor="full_name">Full Name</label>
                    <input type="text" id="full_name" name="full_name" value={profileData.full_name} onChange={handleInputChange} placeholder="Your full name" />
                </div>
                <div className="form-group">
                    <label htmlFor="avatar_url">Profile Picture URL</label>
                    <input type="text" id="avatar_url" name="avatar_url" value={profileData.avatar_url} onChange={handleInputChange} placeholder="https://example.com/avatar.jpg" />
                </div>
                 <div className="profile-email"><strong>Email:</strong> {user?.email}<p className="email-note">Email cannot be changed directly.</p></div>
           ...
           <div className="profile-info">
                ...
                {profileData.avatar_url && (<div className="profile-avatar"><img src={profileData.avatar_url} alt="Profile" /></div>)}
      ...
      <div className="profile-posts">
        <h3>Your Posts</h3>
        {posts.length === 0 ? ( <p className="no-posts">You haven't created any posts yet.</p> ) : (
